...
choosePort(HOST, DEFAULT_PORT)
  .then(port => {
    ...
    if (process.env.LOCAL_CREDENTIALS_FILE || require('fs').existsSync(default_credentials_file)) {
      ...
      credentials = require('js-yaml').load(
        require('fs').readFileSync(credentials_file, 'utf8')
      );
    }

    devServer.app.use(function (req, res, next) {
      console.log("Checking for cookie 2")
